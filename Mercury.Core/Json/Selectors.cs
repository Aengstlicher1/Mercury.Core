...
internal static class Selectors
{
        ...
        string key = "thumbnail")
    {
        var thumbs = element
            ...
            .ToArray();
        var thumbUrl = thumbs.First(t => t.Width == 60 && t.Height == 60)!.Url;

        if (thumbUrl != null && thumbUrl.Contains("=w60-h60"))
        {
            Thumbnail[] thumbnails =
            [
                thumbs[0],
                thumbs[1],
                new Thumbnail(thumbUrl.Replace("=w60-h60", "=w240-h240"), 240, 240),
                new Thumbnail(thumbUrl.Replace("=w60-h60", "=w480-h480"), 480, 480),
                new Thumbnail(thumbUrl.Replace("=w60-h60", "=w720-h720"), 720, 720),
                new Thumbnail(thumbUrl.Replace("=w60-h60", "=w1080-h1080"), 1080, 1080)
            ];
            return thumbnails;
        }
        else
